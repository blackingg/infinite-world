...
void main() {
  ...
  // Directly assign the base color for the trunk
  csm_DiffuseColor = vec4(uBaseColor, 1.0);
  ...
  // Use shared proximity bleach hook
  csm_DiffuseColor.rgb = getProximityBleach(
      uBaseColor, 
      vWorldPosition, 
      uBallPosition, 
      5.0, 
